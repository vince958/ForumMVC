    ...
    <body>
        ...
        <div class="contenu">
            <div class="listeForum">
                <h1><spring:message code="sujet.list.name"/>${forum.name}</h1>
                <table>
                    <tr>
                        <th>Nom</th>
                        <th>Createur</th>
                    </tr>
                    <c:forEach items="${forum.sujets}" var="sujet">
                        <tr>
                            <td><a href="<spring:url value="/sujet/${sujet.id}"/>">${sujet.name}</a></td>
                            <td>${sujet.owner.login}</td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
